...
class ARGS:
    def __init__(self):
        ...
        self.lr = 2e-5  # learning rate for the bert module
        self.other_lr = 2e-4  # learning rate for the module except bert
        ...
        self.eval_batch_size = 16  # evaluation batch size
