...
class BertMrcModel(BaseModel):
    def __init__(self,
        ...
        super(BertMrcModel, self).__init__(
            bert_dir, dropout_prob=args.dropout_prob)
        ...
        self.start_fc = nn.Linear(out_dims, args.num_tags)  # 用于预测起点的全连接层
        self.end_fc = nn.Linear(out_dims, args.num_tags)  # 用于预测终点的全连接层
